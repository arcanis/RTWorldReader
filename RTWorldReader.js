...
(function (global) {
  ...
  require.define('/sources/three.js', function (module, exports, __dirname, __filename) {
    ...
    exports.ThreeEntity.prototype._apply8bData = function (destination, source, useFloats) {
      var map = useFloats ? function (source, offset) {
          return source[offset] / 255;
        } : undefined;
      ...
      setArray(destination, useFloats ? 1 : 255, 3, 4);
    };
    ...
    exports.ThreeEntity.prototype._apply16bffData = function (destination, source, useFloats) {
      var merge = function (source, offset) {
        return source[offset] | source[offset + 1] << 8;
      };
      var map = useFloats ? function (source, offset) {
          return merge(source, offset) / 65535;
        } : merge;
      source = new Uint8Array(source);
    ...
    exports.ThreeEntity.prototype._apply32bfData = function (destination, source, useFloats) {
      var map = useFloats ? undefined : function (source, offset) {
          return Math.floor(source[offset] * 255);
        };
    ...
    exports.ThreeEntity.prototype._loadXtraTextures = function (textureNodes) {
      textureNodes.forEach(function (textureNode) {
        ...
        var texture = this._textures[texn] = this._createTexture(data, width, height, { 0: exports.ThreeEntity.FORMAT_8BA }[format], false);
  ...
  require.define('/sources/parsers.js', function (module, exports, __dirname, __filename) {
    ...
    exports.vertice = function (dataView, offset, length) {
      ...
      offset += 8;
      if (length >= 11 * 8) {
        vertice.sl = dataView.getFloat64(offset, true);
        offset += 8;
        vertice.tl = dataView.getFloat64(offset, true);
        offset += 8;
      } else {
        vertice.sl = null;
        vertice.tl = null;
